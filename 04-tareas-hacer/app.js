...
const { inquirerMenu, pausa, leerInput, inquirerMenuBorrar, confirmar, inquirerMenuChecklist } = require('./helpers/inquirer');
    ...
    do{
        ...
        switch (opt){
            ...
            case '4':
                ...
                break;
            case '5':
                const ids = await inquirerMenuChecklist(tareas.listadoArr);
